    ...
    <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900 p-4">
      ...
      <div className="grid gap-3 text-xs text-slate-200">
        ...
        >
          ...
          {/* Keep the collapsed row height stable and reveal the shape grid in an overlay that grows to the right. */}
          ...
          >
            <p className="mb-2 text-[0.75rem] font-semibold text-emerald-100">Pick a tabletop outline</p>
              ...
              <div className="flex w/full flex-col gap-3 md:w-auto md:flex-1 md:flex-row-reverse md:items-stretch md:gap-4">
                ...
                <div className="flex w-full flex-col items-stretch gap-2 md:w-auto md:flex-none md:items-stretch md:justify-between md:self-stretch">
                  <button
                    ...
                    className={`inline-flex h-full min-h-[52px] w-full items-center justify-center rounded-lg pl-5 pr-3 py-3 text-sm font-semibold transition ${
