...
// Short preset list keeps the edge profile terminology consistent so pricing/search stay reliable.
const edgeProfileOptions = [
  {
    value: 'edged' as TabletopConfig['edgeProfile'],
    label: 'ABS edged',
    description: 'Square ABS strip applied to seal the core and keep a crisp silhouette.',
    searchHint: 'Great for education + hospitality projects where durability matters.'
  },
  {
    value: 'painted-sharknose' as TabletopConfig['edgeProfile'],
    label: 'Painted sharknose',
    description: 'Hand finished bevel that tucks underneath for a floating appearance.',
    searchHint: 'Ideal for premium installs—callouts stay searchable by “sharknose”.'
  }
];
