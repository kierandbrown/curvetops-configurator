...
export const ConfiguratorSnapshot: React.FC<Props> = ({ config, customOutline, swatch }) => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl border border-slate-800/80 bg-slate-950/80 shadow-inner shadow-slate-950/60 aspect-[16/9] min-h-[12rem] md:min-h-[14rem]">
...
const DIMENSION_LABEL_CLASS =
  'pointer-events-none whitespace-nowrap rounded border border-amber-400/30 bg-slate-950/80 px-1.5 py-0.5 text-[0.7rem] font-semibold text-amber-100 shadow-lg backdrop-blur';
