...
const ViewportMouseGuide = () => (
  <div className="pointer-events-none absolute bottom-3 left-3 z-10 flex max-w-sm gap-3 rounded-2xl bg-slate-950/85 p-3 text-[0.7rem] text-slate-200 shadow-2xl ring-1 ring-slate-800">
